...
public class XmlReaderDomWithXPathTest {
	...
	@Test
	public void getAllSaleProducts() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException  {
	...
	@Test
	public void getSaleProductsWithInformedName() throws XPathExpressionException, ParserConfigurationException, SAXException, IOException  {
		XmlReaderDomWithXPath xmlReaderDomWithXPath = new XmlReaderDomWithXPath();
